  ...
  theme: {
    ...
    extend: {
      textColor: {
        ...
        buttonPrimary: withOpacity("--color-buttonPrimary"),
        buttonSecondary: withOpacity("--color-buttonSecondary"),
      ...
      backgroundColor: {
        ...
        secondary: withOpacity("--color-secondary"),
        title: withOpacity("--color-title"),
        secondaryFirstColor: withOpacity("--color-secondaryFirstColor"),
        secondarySecondColor: withOpacity("--color-secondarySecondColor"),
        secondaryThirdColor: withOpacity("--color-secondaryThirdColor"),
        secondaryFourthColor: withOpacity("--color-secondaryFourthColor"),
        a11y: withOpacity("--color-a11y"),
      },
      ringColor: {
        primary: withOpacity("--color-primary"),
